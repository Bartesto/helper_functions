################################################################################################################
# This code is the goods for creating scale bars and north arrows for plotting with ggplot and ggmaps. It works
# out the scale from lat/longs much kudos to the creator.
# Code came from http://egallic.fr/scale-bar-and-north-arrow-on-a-ggplot2-map/
...
# BART NOTE - I have added a size argumet to the geom_segment call for dhi plotting. Remove or adjust if required.
